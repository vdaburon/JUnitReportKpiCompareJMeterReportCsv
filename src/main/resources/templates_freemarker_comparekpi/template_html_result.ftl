...
<html>
  ...
  <body>
<style>
table.table_jp3 {border-collapse: collapse;}
table.table_jp3, table.table_jp3 th, table.table_jp3 tr, table.table_jp3 td {
border: 1px solid black;
text-align: left;
font-family: sans-serif;
font-size:medium; }
table.table_jp3 th:{background-color: #f8f8f8;}
table.table_jp3 tr:nth-child(even) {background-color: #f2f2f2;}
table.table_jp3 td:nth-child(5) { text-align: right; }
</style>
<h1>HTML KPIs Result From JMeter Report Csv Compare</h1>
<h2>Files In<h2>
<table class="table_jp3">
